...
<!-- bpc:generated section=5 hash=984b8969bc1ae9db -->
...
Drawn, this is the tape a lesson shows. Same numbers, same order, same widths, because the widget and the animation are handed this arrangement rather than working out one of their own. Cut at 4 levels from each outermost call.

3 calls from corpora/traces/tier0/write-1byte.txt: 27 calls in 3 call lanes, 5 levels deep at the deepest, and some boxes were placed by call order because a duration is missing. Primitives used: trace-cell.
...
4   vfs_write on cpu 0     2      generic_write_checks                   22.375   4.3%
5   vfs_write on cpu 0     3      generic_write_checks_count             13.667   2.6%
6   vfs_write on cpu 0     4      generic_write_check_limits             4.666    0.9%
7   vfs_write on cpu 0     2      file_remove_privs                      105.750  20.5%
8   vfs_write on cpu 0     3      file_remove_privs_flags                97.708   18.9%
9   vfs_write on cpu 0     4      setattr_should_drop_suidgid            3.667    0.7%
10  vfs_write on cpu 0     4      cap_inode_need_killpriv                79.958   15.5%
11  vfs_write on cpu 0     2      file_update_time                       31.458   6.1%
12  vfs_write on cpu 0     3      file_update_time_flags                 23.416   4.5%
13  vfs_write on cpu 0     4      current_time                           14.417   2.8%
14  vfs_write on cpu 0     2      generic_perform_write                  303.042  58.7%
15  vfs_write on cpu 0     3      balance_dirty_pages_ratelimited        19.750   3.8%
16  vfs_write on cpu 0     4      balance_dirty_pages_ratelimited_flags  11.500   2.2%
17  vfs_write on cpu 0     3      shmem_write_begin                      208.791  40.5%
18  vfs_write on cpu 0     4      shmem_get_folio_gfp                    200.042  38.8%
19  vfs_write on cpu 0     3      __copy_user_ll                         3.792    0.7%
20  vfs_write on cpu 0     3      shmem_write_end                        39.041   7.6%
21  vfs_write on cpu 0     4      folio_mark_dirty                       19.958   3.9%
22  vfs_write on cpu 0     4      folio_unlock                           3.292    0.6%
...
4 calls from corpora/traces/tier0/two-writes.txt: 39 calls in 4 call lanes, 5 levels deep at the deepest, and some boxes were placed by call order because a duration is missing. Primitives used: trace-cell.

```
#   lane                   depth  call                                   took     width   note
--  ---------------------  -----  -------------------------------------  -------  ------  --------------------
0   mutex_unlock on cpu 0  0      mutex_unlock                           17.250   100.0%
1   vfs_write on cpu 0     0      vfs_write                              549.333  100.0%
2   vfs_write on cpu 0     1      shmem_file_write_iter                  535.667  97.5%
3   vfs_write on cpu 0     2      down_write                             4.958    0.9%
4   vfs_write on cpu 0     2      generic_write_checks                   26.042   4.7%
5   vfs_write on cpu 0     3      generic_write_checks_count             15.750   2.9%
6   vfs_write on cpu 0     4      generic_write_check_limits             5.208    0.9%
7   vfs_write on cpu 0     2      file_remove_privs                      125.916  22.9%
8   vfs_write on cpu 0     3      file_remove_privs_flags                116.750  21.3%
9   vfs_write on cpu 0     4      setattr_should_drop_suidgid            4.291    0.8%
10  vfs_write on cpu 0     4      cap_inode_need_killpriv                82.583   15.0%
11  vfs_write on cpu 0     2      file_update_time                       33.959   6.2%
12  vfs_write on cpu 0     3      file_update_time_flags                 24.875   4.5%
13  vfs_write on cpu 0     4      current_time                           14.833   2.7%
14  vfs_write on cpu 0     2      generic_perform_write                  302.500  55.1%
15  vfs_write on cpu 0     3      balance_dirty_pages_ratelimited        22.500   4.1%
16  vfs_write on cpu 0     4      balance_dirty_pages_ratelimited_flags  13.292   2.4%
17  vfs_write on cpu 0     3      shmem_write_begin                      203.083  37.0%
18  vfs_write on cpu 0     4      shmem_get_folio_gfp                    192.959  35.1%
19  vfs_write on cpu 0     3      __copy_user_ll                         4.083    0.7%
20  vfs_write on cpu 0     3      shmem_write_end                        44.792   8.2%
21  vfs_write on cpu 0     4      folio_mark_dirty                       23.125   4.2%
22  vfs_write on cpu 0     4      folio_unlock                           4.000    0.7%
23  vfs_write on cpu 0     2      up_write                               4.208    0.8%
24  vfs_write on cpu 0     0      vfs_write                              121.875  100.0%
25  vfs_write on cpu 0     1      anon_pipe_write                        109.458  89.8%
26  vfs_write on cpu 0     2      mutex_lock                             4.167    3.4%
27  vfs_write on cpu 0     2      __alloc_pages_noprof                   28.250   23.2%
28  vfs_write on cpu 0     3      __alloc_frozen_pages_noprof            18.833   15.5%
29  vfs_write on cpu 0     4      get_page_from_freelist                 8.500    7.0%
30  vfs_write on cpu 0     2      __copy_user_ll                         4.084    3.4%
31  vfs_write on cpu 0     2      mutex_unlock                           4.000    3.3%
32  vfs_write on cpu 0     2      __wake_up_sync_key                     23.625   19.4%
33  vfs_write on cpu 0     3      __wake_up_common_lock                  14.291   11.7%
34  vfs_write on cpu 0     4      __wake_up_common                       4.000    3.3%
35  vfs_write on cpu 0     2      kill_fasync                            4.000    3.3%
36  vfs_write on cpu 0     0      vfs_write                              unknown  100.0%
37  vfs_write on cpu 0     1      __copy_user_ll                         4.125    50.0%   placed by call order
38  vfs_write on cpu 0     1      mutex_lock                             3.917    50.0%   placed by call order
```
<!-- bpc:end section=5 -->
