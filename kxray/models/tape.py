"""A function_graph trace: a forest of frames, and the things that happened between them.

This is the model the tape widget draws, the animation moves and the blueprint prints. One parser
fills it in and none of the three reaches back past it.
"""
